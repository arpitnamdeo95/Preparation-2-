...
const RoadmapHub = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-12 md:space-y-16 animate-fade-in py-8 md:py-12 px-0">
            ...
            <div className="relative group cursor-pointer" onClick={() => generateMasterBlueprintPDF("User")}>
                ...
                <div className="relative p-6 md:p-10 rounded-3xl border border-white/10 bg-[#0a0a14] flex flex-col lg:flex-row items-center justify-between gap-8 h-full overflow-hidden">
                        ...
                        <div className="space-y-2">
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
                                ...
                                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                                    70+ Page Expert Guide
                                </span>
                            </div>
                            <h3 className="text-xl md:text-2xl font-black text-white uppercase tracking-tight">Complete Career Blueprint <span className="text-brand-400">2026</span></h3>
                            <p className="text-xs md:text-sm text-slate-400 max-w-lg leading-relaxed">
                                Download the unified 70-page master document covering CS protocols, GATE strategies, Sales frameworks, and Core Engineering industry transitions.
                            </p>
                        </div>
                    </div>

                    <button className="w-full lg:w-auto px-8 py-4 bg-white text-black font-black text-xs uppercase tracking-[0.2em] rounded-2xl hover:bg-brand-400 hover:text-white transition-all transform hover:scale-105 active:scale-95 shadow-[0_20px_50px_rgba(255,255,255,0.1)]">
                        Generate PDF
                    </button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                {ROADMAP_METADATA.map((roadmap) => (
                    ...
                    >
                        ...
                        <div className="relative p-6 md:p-8 flex flex-col sm:flex-row items-start gap-6 md:gap-8">
                            <div className="flex-shrink-0 w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-brand-400 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                                {roadmap.icon}
                            </div>
                            <div className="flex-1">
                                <h3 className="text-lg md:text-xl font-bold text-white mb-2 tracking-tight">{roadmap.title}</h3>
                                <p className="text-xs md:text-sm text-slate-500 leading-relaxed mb-6 line-clamp-2">{roadmap.desc}</p>
                                ...
                                <div className="flex flex-wrap items-center gap-2 md:gap-3">
                                    <button
                                        ...
                                        className="px-3 py-2 md:px-4 md:py-2 bg-brand-600 text-white font-bold text-[9px] md:text-[10px] uppercase tracking-widest rounded-lg hover:bg-brand-500 transition-all shadow-lg shadow-brand-600/20"
                                    >
                                        Execute Blueprint
                                    </button>
                                    <button
                                        ...
                                        className="px-3 py-2 md:px-4 md:py-2 bg-white/5 text-slate-400 border border-white/10 font-bold text-[9px] md:text-[10px] uppercase tracking-widest rounded-lg hover:bg-white/10 hover:text-white transition-all"
                                    >
                                        Visual Graph
                                    </button>
                                </div>
            ...
            {/* Premium Note */}
            <div className="p-6 md:p-8 rounded-[2rem] border border-white/5 bg-gradient-to-r from-brand-500/5 to-transparent flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="space-y-1 text-center md:text-left">
                    <h4 className="text-sm font-bold text-white">Advanced Resource Integration</h4>
                    <p className="text-[10px] md:text-xs text-slate-500">All blueprints include curated resources, interview prep, and project blueprints.</p>
                </div>
